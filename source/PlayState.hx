...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Muerete ala Verga!', 0.2], //From 0% to 19%
		['Tienes Cancer', 0.4], //From 20% to 39%
		['Tienes Sida', 0.5], //From 40% to 49%
		['Muere', 0.6], //From 50% to 59%
		['Come Verga', 0.69], //From 60% to 68%
		['Sez', 0.7], //69%
		['Verga', 0.8], //From 70% to 79%
		['Vete Ala Verga', 0.9], //From 80% to 89%
		['Ala Verga!', 1], //From 90% to 99%
	...
	override public function create()
	{
		...
		timeBar.createFilledBar(0xFF000000, FF8E82EF);
		...
		scoreTxt.setFormat(Paths.font(" vcr.tff"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	{
		scoreTxt.text = 'C Score : ' + songScore
		+ ' | Misses : ' + songMisses
		+ ' | Accuracy : ' + 
	...
	public function RecalculateRating(badHit:Bool = false) {
		...
		if(ret != FunkinLua.Function_Stop)
		{
			...
			if (songMisses > 0 && songMisses < 10) ratingFC = "[SDBC]";
			else if (songMisses >= 10) ratingFC = "[Meh]";
		}
